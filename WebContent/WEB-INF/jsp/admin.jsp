...
<div class="content">
    <div class="dl-main-nav">
        ...
        <ul id="J_Nav"  class="nav-list ks-clear">
            <li class="nav-item dl-selected"><div class="nav-item-inner nav-home">管理员</div></li>		<li class="nav-item dl-selected"><div class="nav-item-inner nav-order">用户相关</div></li>
        </ul>
    </div>
...
<script>
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:[{text:'个人中心',items:[{id:'2',text:'个人信息',href:'editForm.action'},{id:'3',text:'待开发功能',href:'QuestionManagerForm.action'}]}]},
